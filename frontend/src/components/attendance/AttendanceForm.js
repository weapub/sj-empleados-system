  ...
  return (
    <Card className="shadow-sm">
      <Card.Header className="bg-white">
        <h4 className="mb-0">{isEdit ? 'Editar Inasistencia/Tardanza' : 'Registrar Inasistencia/Tardanza'}</h4>
      </Card.Header>
      <Card.Body>
          ...
          <Row>
            ...
            <Col md={6}>
              <Form.Group className="mb-3">
                ...
                {currentDocUrl && (
                  <div className="mt-2">
                    <Button variant="outline-secondary" size="sm" onClick={() => setViewerOpen(true)}>
